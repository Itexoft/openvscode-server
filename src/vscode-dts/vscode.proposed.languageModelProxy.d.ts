...
declare module 'vscode' {
	export interface LanguageModelProxyProvider {
		provideModelProxy?(requestingExtensionId: string, token: CancellationToken): ProviderResult<LanguageModelProxy | undefined>;
	}
	...
	export namespace lm {
		...
		/**
		 * Internal API used by chatParticipantPrivate to register a proxy provider.
		 */
